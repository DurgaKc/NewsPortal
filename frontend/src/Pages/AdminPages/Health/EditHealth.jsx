...
import { getHealthById, updateHealth } from "./HealthApi";
import toast from "react-hot-toast";

const backendUrl = import.meta.env.VITE_BACKEND_URL;

const EditHealth = ({ onClose, id }) => {
  ...
  // ✅ Mutation for updating health news
  const updateHealthNews = useMutation({
    mutationFn: (updatedNews) => {
      const token = localStorage.getItem("token");
      return updateHealth(id, updatedNews, token);
    },
    onSuccess: () => {
  ...
  const handleEdit = (e) => {
    e.preventDefault();
    setLoading(true);
    updateHealthNews.mutate(formData);
    setLoading(false);
  };
