...
import { addNews } from "./InterApi";

const AddInternational = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await addNews(formData, token);

      toast.success("International News added successfully!");
      setFormData({
        topic: "",
        description: "",
        date: "",
