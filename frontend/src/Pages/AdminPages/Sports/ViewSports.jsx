...
import { getAllSports } from "./SportsApi";
  ...
  return (
    <Grid>
      ...
      <Box sx={{ display: "flex", justifyContent: "flex-end", mb: 2, mr: 12 }}>
        <Link to="/admin/sports/addsports" style={{ textDecoration: "none" }}>
          <Button
            variant="contained"
      ...
      <Dialog open={openEditDialog} onClose={handleCloseDialog}>
        <EditSports id={selectedNewsId} onClose={handleCloseDialog} />
      </Dialog>

      {/* Delete Dialog */}
      <Dialog open={openDeleteDialog} onClose={handleCloseDialog}>
        <DeleteSports id={selectedNewsId} onClose={handleCloseDialog} />
      </Dialog>
    </Grid>
  );
};
