...
import { addPolitics } from "./PoliticsApi";

const AddPoliticsNews = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await addPolitics(formData, token);

      toast.success("Politics news added successfully!");
      setFormData({
        topic: "",
        description: "",
        date: "",
...
export default AddPoliticsNews;
